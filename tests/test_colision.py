...
from app.core.collision.CollisionDetection import hay_colision_mejorada
from app.core.collision.CollisionAnalysis import analizar_colision_detallada
def test_precision_colision():
    ...
    print(f"Test 1 - Elipses que se tocan: {hay_colision_mejorada(e1, e2, tolerancia=0.5)}")
    ...
    print(f"Test 2 - Elipses separadas: {hay_colision_mejorada(e3, e4)}")
    
    # Test case 3: Elipses superpuestas
    e5 = Elipse(0, 0, 4, 3, "horizontal")
    e6 = Elipse(2, 1, 3, 2, "vertical")
    
    print(f"Test 3 - Elipses superpuestas: {hay_colision_mejorada(e5, e6)}")
